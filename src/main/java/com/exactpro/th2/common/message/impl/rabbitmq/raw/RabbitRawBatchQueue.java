...
public class RabbitRawBatchQueue implements MessageQueue<RawMessageBatch> {
    ...
    @Override
    public MessageSubscriber<RawMessageBatch> createSubscriber() {
    ...
    @Override
    public MessageSender<RawMessageBatch> createSender() {
