...
public class EventBatchQueue extends AbstractRabbitQueue<EventBatch> {
    ...
    @Override
    protected MessageSubscriber<EventBatch> createSubscriber(@NotNull ConnectionOwner connectionOwner, @NotNull QueueConfiguration queueConfiguration) {
        ...
        var subscribeTarget = SubscribeTarget.builder()
                ...
                .build();
        eventBatchSubscriber.init(connectionOwner, queueConfiguration.getExchange(), subscribeTarget);
